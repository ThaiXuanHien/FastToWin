...
internal val englishProfileTexts = mapOf(
    ...
    TextKey.CurrentSessionDuration to "Current session {duration}", TextKey.MissionPlayThree to "Play 3 matches today",
    TextKey.MissionWinOne to "Win 1 match today", TextKey.MissionCorrectHundred to "Find 100 correct numbers this week",
    ...
    TextKey.MatchTapSummary to "{duration} • {correct} correct • {wrong} wrong", TextKey.NoReplayData to "No tap data is available for this match.",
    TextKey.ReplayTurn to "Turn {current}/{total}", TextKey.CorrectSelection to "Correct: {number}",
    TextKey.WrongSelectionNeed to "Wrong • Target was {number}", TextKey.StopReplay to "STOP", TextKey.Replay to "REPLAY",
...
internal val vietnameseProfileTexts = englishProfileTexts + mapOf(
    ...
    TextKey.CurrentSessionDuration to "Phiên hiện tại {duration}", TextKey.MissionPlayThree to "Chơi 3 trận hôm nay",
    TextKey.MissionWinOne to "Thắng 1 trận hôm nay", TextKey.MissionCorrectHundred to "Chọn đúng 100 số trong tuần",
    ...
    TextKey.MatchTapSummary to "{duration} • Đúng {correct} • Sai {wrong}", TextKey.NoReplayData to "Trận này chưa có dữ liệu lượt bấm để phát lại.",
    TextKey.ReplayTurn to "Lượt {current}/{total}", TextKey.CorrectSelection to "Chọn đúng số {number}",
    TextKey.WrongSelectionNeed to "Chọn sai • Cần tìm {number}", TextKey.StopReplay to "DỪNG", TextKey.Replay to "PHÁT LẠI",
