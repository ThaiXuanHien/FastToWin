...
) + simplifiedChineseShellAuthTexts + simplifiedChineseGameplayTexts + simplifiedChineseProfileTexts + simplifiedChineseSocialShopTexts + simplifiedChineseProtocolMessageTexts + simplifiedChineseDeliveryTexts + residualTexts(AppLanguage.SIMPLIFIED_CHINESE) + economyProgressionTexts.getValue(AppLanguage.SIMPLIFIED_CHINESE) + playQuotaTexts.getValue(AppLanguage.SIMPLIFIED_CHINESE),
    quantities = mapOf(
