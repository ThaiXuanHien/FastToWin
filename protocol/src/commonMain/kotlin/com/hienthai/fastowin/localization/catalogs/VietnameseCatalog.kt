...
) + vietnameseShellAuthTexts + vietnameseGameplayTexts + vietnameseProfileTexts + vietnameseSocialShopTexts + vietnameseProtocolMessageTexts + vietnameseDeliveryTexts,
    quantities = mapOf(
