...
) + germanShellAuthTexts + germanGameplayTexts + germanProfileTexts + germanSocialShopTexts + germanProtocolMessageTexts + germanDeliveryTexts + residualTexts(AppLanguage.GERMAN),
    quantities = mapOf(
