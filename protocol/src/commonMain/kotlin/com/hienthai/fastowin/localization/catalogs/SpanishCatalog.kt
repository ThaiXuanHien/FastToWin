...
) + spanishShellAuthTexts + spanishGameplayTexts + spanishProfileTexts + spanishSocialShopTexts + spanishProtocolMessageTexts + spanishDeliveryTexts + residualTexts(AppLanguage.SPANISH) + economyProgressionTexts.getValue(AppLanguage.SPANISH) + playQuotaTexts.getValue(AppLanguage.SPANISH),
    quantities = mapOf(
