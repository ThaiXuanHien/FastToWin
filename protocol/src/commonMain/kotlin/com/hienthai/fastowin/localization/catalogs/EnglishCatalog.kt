...
) + englishShellAuthTexts + englishGameplayTexts + englishProfileTexts + englishSocialShopTexts + englishProtocolMessageTexts + englishDeliveryTexts + residualTexts(AppLanguage.ENGLISH),
    quantities = mapOf(
