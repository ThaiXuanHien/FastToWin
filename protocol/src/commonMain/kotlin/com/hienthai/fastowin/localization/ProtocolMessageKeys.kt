...
fun protocolTextKeyForCode(code: String): TextKey? = when (code) {
    ...
    "INVALID_ACCESS_TOKEN", "INVALID_REFRESH_TOKEN", "INVALID_RESET_TOKEN", "INVALID_RESUME_TOKEN", "INVALID_SESSION_ID",
    ...
    "PLAYER_BUSY" -> TextKey.ServerPlayerActivityConflict
    "ALREADY_IN_ROOM" -> TextKey.ServerAlreadyInRoom
    "TOURNAMENT_ALREADY_ACTIVE" -> TextKey.ServerTournamentAlreadyActive
    "FRIEND_BUSY" -> TextKey.ServerPlayerBusy
    ...
    "TOURNAMENT_ALREADY_CREATED", "TOURNAMENT_ENTRY_ALREADY_PAID",
