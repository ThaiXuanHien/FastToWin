...
) + koreanShellAuthTexts + koreanGameplayTexts + koreanProfileTexts + koreanSocialShopTexts + koreanProtocolMessageTexts + koreanDeliveryTexts + residualTexts(AppLanguage.KOREAN) + economyProgressionTexts.getValue(AppLanguage.KOREAN) + playQuotaTexts.getValue(AppLanguage.KOREAN),
    quantities = mapOf(
