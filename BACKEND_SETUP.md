...
Protocol WebSocket hiện tại là phiên bản 14. Sau khi cập nhật ứng dụng, cần khởi động lại backend để client và server dùng cùng phiên bản.
